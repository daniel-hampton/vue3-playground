...
const ripples = {
  ...
  hide(el: HTMLElement | null) {
    ...
    const animation = (ripples as HTMLCollectionOf<HTMLElement>)[ripples.length - 1]
...
// Changed type of value from 'any' to 'unknown' per ESLint hint.
...
// binding: VNodeDirective changed to binding: any
...
// Removed node:VNode as 3rd argument.
function directive(el: HTMLElement, binding: DirectiveBinding) {
